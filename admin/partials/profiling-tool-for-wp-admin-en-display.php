    ...
    <div id="pluginProfile" class="patp-body tabcontent">
        ...
        <div class="patp_colors-container">
            ...
            <table class="wp-list-table widefat fixed striped table-view-list pages">
				...
				echo '<div class="postbox no-bottom"><div class="postbox-header no-bottom"><h3>'. esc_html__('Current plugin theme active', 'profiling-tool-for-wp') .': <strong>'.count($all_active_plugins).'</strong></h3></div></div>';
